...
| `GET` | `/api/v1/overview` | รวมสถานะพร้อมข้อมูล pending/active (แสดง VID ถ้ามี) | `curl http://HOST:8080/api/v1/overview`<br>`{"connectors":[{"cpid":"Gresgying02","connectorId":1,"status":"Preparing","pending":{"vid":"VID:XYZ"}}]}` |
